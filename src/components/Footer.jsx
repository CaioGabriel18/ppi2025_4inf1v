    ...
    return (
        <footer className={styles.footer}>
            ...
            <div className={styles.meunome}>
                <p>Caio Gabriel Nascimento dos Santos</p>
            </div>

            <div className={styles.icons}>
                <a href="https://instagram.com/caiogabriel4532" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://github.com/CaioGabriel18" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://www.linkedin.com/in/caio-gabriel-b1763036b/" target="_blank" rel="noopener noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
